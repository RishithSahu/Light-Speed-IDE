...
pub use editor::{EditorCore, OpenRequest, Position, TabPresentation, TextRange};
...
pub use render::{
    build_snapshot, CursorPresentation, DocumentPresentation, Invalidation, RenderLine,
    RenderSnapshot, SelectionSpan, Viewport,
};
